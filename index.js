...
// Подключаем задачу
require('./scheduledTasks'); // Подключаем scheduledTasks.js, чтобы cron-задачи запускались при старте сервера
...
// HTTPS options
const httpsOptions = {
    key: fs.readFileSync('/etc/letsencrypt/live/cargoasem17.kz/privkey.pem'),
    cert: fs.readFileSync('/etc/letsencrypt/live/cargoasem17.kz/fullchain.pem')
};
